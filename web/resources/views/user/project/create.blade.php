            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ request()->url() }}" id="main_form">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="finishday">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control autonumeric-currency" placeholder="0" aria-label="From" name="budgetfrom">
                                <span class="input-group-text">-</span>
                                <input type="text" class="form-control autonumeric-currency" placeholder="0" aria-label="To" name="budgetto">
                            </div>
                        </div>
                    </div>
