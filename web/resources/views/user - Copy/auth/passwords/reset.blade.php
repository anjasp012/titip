...
<form method="post" action="{{ request()->url() }}" id="main_form">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="email" name="email" value="{{ $target->email }}" readonly>
...
<div class="row mt-3">
    <div class="col-sm-12 text-center {{ $text_class }}">
        <p class="{{ $text_class }}-50 mb-0"><a href="{{ url('auth/login') }}" class="{{ $text_class }} ml-1"><b>Masuk</b></a> - <a href="{{ url('auth/register') }}" class="{{ $text_class }}-50 ml-1"><b>Daftar</b></a></p>
    </div>
</div>
@else
<div class="row mt-3">
