...
<head>
    ...
    <link href="{{ asset('assets/'.website_config('template')->number.'/plugins/alertify/alertify.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('assets/prism.css') }}" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <header id="page-topbar">
            <div class="navbar-header">
                ...
                <div class="d-flex align-items-center">
                    <a class="text-dark d-none d-sm-inline-block ml-2" href="javascript:void(0)">
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ url('account/log/login') }}">
                                <span>Log Masuk</span>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ url('account/log/balance') }}">
                                <span>Log Saldo</span>
                            </a>
    ...
    <script src="{{ asset('assets/'.website_config('template')->number.'/plugins/alertify/alertify.min.js') }}"></script>
