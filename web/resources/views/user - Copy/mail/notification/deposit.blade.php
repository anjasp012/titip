                            ...
                            <table class="inner-body table-3" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="content-cell td-4">
                                            ...
                                            <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td class="td-6">
                                                        <p class="p">
                                                        - <b>ID:</b> {{ $id }}<br />
                                                        - <b>Metode:</b> {{ $method }}<br />
                                                        - <b>Jumlah:</b> Rp {{ number_format($amount,0,',','.') }}<br />
                                            ...
                                            <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td class="td-6">
                                                        ...
                                                        Kami akan segera memproses Deposit anda, silahkan untuk melunasi pembayaran terlebih dahulu.
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        @else
                                            <p class="p">
                                                Admin telah menambahkan anda deposit secara langsung, berikut adalah informasi deposit anda.
                                            </p>
                                            <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td class="td-6">
