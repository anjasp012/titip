                            ...
                            <table class="inner-body table-3" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="content-cell td-4">
                                        ...
                                        <p class="p">
                                            Silahkan untuk mengklik Tombol "Aktivasi Akun" dibawah ini, untuk mengaktifkan akun Anda.
                                        </p>
                                                        ...
                                                        <tr>
                                                            <td class="td-6" align="center">
                                                                <table class="table-5" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="{{ $url }}" class="button button-primary" target="_blank" style="
                                                                                        box-sizing: border-box;
                                                                                        font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji',
                                                                                            'Segoe UI Symbol';
                                                                                        position: relative;
                                        ...
                                        <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                <td class="td-6">
                                                    ...
                                                    Jika Anda mengalami masalah saat mengklik tombol "Aktivasi Akun", salin dan tempel URL di bawah ini ke browser web Anda:
                                                        <span>
                                                            <a href="{{ $url }}" style="color: #3869d4;">
                                                                {{ $url }}
                                                            </a>
                                                        </span>
                                                    </p>
