                            ...
                            <table class="inner-body table-3" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="content-cell td-4">
                                        ...
                                        @if ($status == 'Waiting')
                                        <p class="p">
                                            {{ $username }} telah mengirimkan anda tiket, berikut adalah informasi tiket pengguna.
                                        </p>
                                        @elseif ($status == 'Replied')
                                        <p class="p">
                                            {{ $username }} telah membalas tiket anda, berikut adalah informasi tiket pengguna.
                                        </p>
