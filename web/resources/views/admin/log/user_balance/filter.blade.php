<a href="javascript:;" data-toggle="modal" data-target="#modal-filter" class="btn btn-primary btn-sm">
	<i class="fa fa-filter fa-fw"></i> Filter Saldo Pengguna
</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="modal-filterLabel"><i class="fa fa-filter"></i> Filter Saldo Pengguna</h5>
            ...
            <div class="modal-body">
                <form method="GET" id="filter-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">							
                            <select class="form-control" name="filter_type" id="filter_type" data-toggle="select2">
                                <option value="" selected>Semua...</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">							
                            <select class="form-control" name="filter_action" id="filter_action" data-toggle="select2">
                                <option value="" selected>Semua...</option>
