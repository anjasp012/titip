<a href="javascript:;" data-toggle="modal" data-target="#modal-filter" class="btn btn-primary btn-sm">
	<i class="fa fa-filter fa-fw"></i> Filter Mutasi Bank
</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="modal-filterLabel"><i class="fa fa-filter"></i> Filter Mutasi Bank</h5>
            ...
            <div class="modal-body">
                <form method="GET" id="filter-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="form-control" name="filter_bank" id="filter_bank" data-toggle="select2">
                                <option value="" selected>Semua...</option>
